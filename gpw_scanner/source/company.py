class Company:
    def __init__(self, name, ticker, share_price, income_revenue_collection, income_gross_profit_collection, income_EBIT_collection, income_net_profit_collection, share_amount, price_to_earnings_ratio_collection):
        self.name = name
        self.ticker = ticker
